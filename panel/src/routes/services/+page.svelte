...
<div class="p-6 max-w-6xl mx-auto space-y-6">
	<div class="flex items-center justify-between">
		<div>
			...
			<p class="text-muted-foreground mt-1">Local service status and domains</p>
		</div>
	...
	{:else}
		<div class="space-y-4">
			{#each services as service}
				<Card.Root class={service.status === 'RUNNING' ? 'border-green-500/30' : 'border-red-500/30'}>
					<Card.Content class="p-5">
								...
								<div class="flex flex-wrap gap-2">
									{#each service.domains as domain}
										<a
											...
											class="inline-flex items-center gap-1 px-2 py-0.5 bg-primary/10 text-accent-blue text-xs font-mono rounded hover:bg-primary/20 transition-colors"
										>
											{domain}
						...
						{#if service.logTail.length > 0}
							<details class="group mt-3">
								...
								<div class="mt-2 bg-muted rounded p-3 max-h-48 overflow-auto">
